...
export const ACT4_SCENES = [
  {
    ...
    text:
      "In public, with others watching, your anger and doubt boil over. Desdemona pleads her innocence while Iago watches from the side.",
    ...
    choices: [
      {
        ...
        unlockLogs: [],
        tags: ["jealous", "public"],
        setFlags: { everActedWithSelfControlInPublic: true }
      },
      {
        id: "freeze_out",
      ...
      },
      {
        ...
        tags: ["jealous", "violent", "public"],
        setFlags: {
          hasStruckDesdemona: true,
          tookViolentBranch: true
        }
      }
    ]
  },
  // Non-violent branch
  {
    ...
    text:
      "Desdemona withdraws, shaken, while Emilia follows to comfort her. You remain behind, feeling every eye on you.",
    choices: [
      {
        id: "overhear_half",
  ...
  // Violent branch
  {
    ...
    text:
      "Lodovico and the others stare in disbelief after you strike Desdemona. She leaves in tears. Lodovico asks quietly if this is truly the general they once respected.",
    choices: [
      {
        id: "nothing_is_wrong",
        text: "Say that nothing is wrong and it is a private matter.",
        effects: { trust: -3, jealousy: +4, dependence: +3, reputation: -5 },
  ...
  },
  {
    ...
    textByMode: {
      Resisting:
        "Later, you see Desdemona from a distance, her shoulders shaking as Emilia wraps an arm around her. Regret gnaws at the edges of your anger.",
      Torn:
        "Later, you see Desdemona from a distance, her shoulders shaking as Emilia wraps an arm around her. You cannot tell if her grief is guilt or hurt.",
      Consumed:
        "Later, you see Desdemona from a distance, her shoulders shaking as Emilia wraps an arm around her. Her tears look to you like the last defence of a trapped liar."
    },
    choices: [
      {
        id: "maybe_too_harsh",
